pixel.LevelTwo = function(game){
    ...
    /* circle coordinates*/
    this.circleCoordinateX = [76, 401, 401, 522, 648, 727, 514, 752, 752, 1084, 1189, 1709, 2119, 2186, 2355, 2711, 2865, 3324, 3374, 3859, 3859,3877, 3842, 3921, 4047, 4057, 4170, 4170, 4170, 4170, 4289, 4494, 4494, 4716, 4690, 4850, 4764, 4706, 5072, 5242, 5310, 5584, 5995, 6053, 6162, 6515, 6491, 6551, 6730, 194, 401, 401, 694, 76, 306, 514, 2575, 2722, 4058, 4265, 4376, 6729, 6490, 4265, 4685.7];
    
    this.circleCoordinateY = [511, 116, 114, 700, 846, 790, 74, 308, 240, 846, 846, 846, 224, 224, 282, 691, 178, 68, 68, 676, 609, 439, 130, 72, 217, 845, 802, 705, 649, 856, 82, 480, 471, 828, 462, 586, 381, 27, 418, 358, 358, 196, 91, 91, 91, 148, 626, 458, 858, 276, 264, 62, 528, 444, 61, 128, 452, 327, 794, 858, 642, 809, 693, 597, 909.7];
    ...
    //usb position
    this.usbPositionX = [2593, 4861, 3930, 1717, 3764];
    this.usbPositionY = [231, 564, 530, 197, 429];
    ...
    this.instructionboxX = [174, 1758, 4894];
    this.instructionboxY = [890, 970, 970];
    ...
    //worrior variable
    this.bitDefender = null;
    this.bitDefenderDIalog = null;
    this.closebtn = null;
    pixel.EnteredSimon = false;
...
pixel.LevelTwo.prototype = {
    ...
    create: function(){
        ...
        if(pixel.EnteredSimon === false){
        
            this.game.time.events.add(500, this.addBitDefender, this);
        }
    ...
    BuildLevelOne: function(){
        ...
        //this.platformLevelOne.setAll('body.gravity', false);
        ...
        //this.circleGroup.setAll('body.gravity', false);
        ...
        this.VerticalSharpHorizontalGroup.setAll('body.immovable', true);
        //this.VerticalSharpHorizontalGroup.setAll('body.gravity', false);
        ...
        this.shortSharpHorizontalPillar.setAll('body.immovable', true);
        //this.shortSharpHorizontalPillar.setAll('body.gravity', false);
        ...
        this.shortsharpHorizontalTwo.setAll('body.immovable', true);
        //this.shortsharpHorizontalTwo.setAll('body.gravity', false);
        ...
        this.SmallSmoothVerticalPillarGroup.setAll('body.immovable', true);
        //this.SmallSmoothVerticalPillarGroup.setAll('body.gravity', false);

    },

    addBitDefender:function(){

        //add worrior instructions
        this.bitDefender = this.game.add.sprite(80, 50, 'level2Instructions');
        this.bitDefender.fixedToCamera = true;
        this.closebtn = this.game.add.button(110, 80, 'close', this.startGameTwo, this, 2, 1, 0);
        this.closebtn.fixedToCamera = true;
        this.closebtn.anchor.setTo(0.5, 0.5);
        this.closebtn.scale.setTo(0.5);
        pixel.isTheLevelPaused = true;
        
    },

    startGameTwo:function(){
        this.bitDefender.kill();
        this.closebtn.kill();
        pixel.isTheLevelPaused = false;
    },

    addBitDefenderSpeechBubble:function(){
        this.bitDefenderDIalog = this.game.add.sprite(550, 700, 'speechbubblelvl2One');
        this.bitDefenderDIalog.scale.setTo(0.4);
        this.game.time.events.add(7000, this.addSecondSpeech, this);
    },

    addSecondSpeech: function(){
        this.bitDefenderDIalog.alpha = 0;
        this.bitDefenderDIalog = this.game.add.sprite(550, 700, 'speechbubblelvl2Two');
        this.bitDefenderDIalog.scale.setTo(0.4);
        this.game.time.events.add(7000, this.startLevelTwoNow, this);

    },

    startLevelTwoNow: function(){
        this.bitDefender.alpha = 0;
        this.bitDefenderDIalog.alpha = 0;
        pixel.isTheLevelPaused = false;
    },
    ...
    assignpillarmovment: function(move){
       ...
       if(pixel.isTheLevelPaused === false){
    ...
    gameElement: function(){
        ...
        for (var i =0; i <3; i++){
            var button = this.add.sprite(this.instructionboxX[i], this.instructionboxY[i] -15, 'box' , 0, this.instructionbox);
        ...
        this.enimie.setAll('body.immovable', true);
        //this.enimie.setAll('body.gravity', false);
        ...
        this.flyingEnimie.setAll('body.immovable', true);
        //this.flyingEnimie.setAll('body.gravity', false);
        ...
        if(pixel.winTheTest === false){

        //var usbposition = Math.round(Math.random()*4);
        var usbposition = this.game.rnd.integerInRange(0,4);
        this.flashLocation = usbposition;
        console.log(this.flashLocation);
        ...
        this.usb.body.gravity = false;

        console.log("usb old locatio");
        console.log(this.usb.x);
        ...
        this.fullHeart.fixedToCamera = true;
        ...
        //adding the player
        this.player = this.add.sprite(pixel.x, pixel.y, 'player2');
        ...
        this.player.animations.add('flying', [7,8,7,8,7,8], 10, true);
        ...
        this.warnTime = this.game.add.audio('AlertTime');
        this.playerHitSound = this.game.add.audio('PlayerHitByBossAudio');
    ...
    updateTimer: function(){
       ...
       if(pixel.isTheLevelPaused === false){
            ...
            if(this.gametime === 50 || this.gametime === 47 || this.gametime === 45){
                this.warnTime.play();
            }
        }
    },
    ...
    enemiKill: function(player, enemy){
        ...
        if(this.glitcCount === false){
            ...
            if(this.playerHealth > 0){
                ...
                this.fullHeart.getAt(this.countHealth).alpha = 0;
                this.countHealth --;
    ...
    playerGetKey: function(){
        pixel.x = this.player.x;
        pixel.y = this.player.y;
        ...
        this.usb.kill();
        pixel.isTheLevelPaused = true;
        this.state.start('simon');

   },

   getUsbCharachter: function(){

        this.gameMusic.stop();
        this.getflash = this.add.sprite(this.player.x , this.player.y - 10, 'pixelWithFlash');
   ...
   nextlvlstart: function(){
    ...
    update: function(){
            ...
            if (pixel.getUSB === true && pixel.winTheTest === true){

                this.getUsbCharachter();
                pixel.winTheTest = false;
            }

            if(pixel.getUSB === false &&  pixel.loseTest === true){

                pixel.loseTest = false;
                var usbposition = this.game.rnd.integerInRange(0,4);
                while (usbposition === this.flashLocation){

                    var usbposition = this.game.rnd.integerInRange(0,4);
                }

                if(usbposition != this.flashLocation){
                this.flashLocation = usbposition; 
                this.usb.x = this.usbPositionX[usbposition];
                this.usb.y = this.usbPositionY[usbposition];
                }
                console.log("usb new locatio");
                console.log(this.usb.x);
            }
            ...
            if(pixel.isTheLevelPaused === false){
                ...
                if(this.counterMove === true){
                    ...
                    if(/*this.jumpButton.isDown*/ this.MovmentPlayer.up.isDown && (this.player.body.onFloor() || this.player.body.touching.down)){
                        this.jumpSound.play();
