...
pixel.puzzle.prototype = {
	...
	create: function(){
        ...
        //add the switch
        this.theswitch = this.add.sprite(410, 635, 'glitch-button');
        ...
        this.theglitchSound.loop = false;
	...
	addBlockPixels: function(){
        ...
        this.pixelBlocks5.setAll('body.gravity', true);
    ...
    if (this.isThePuzzlePaused === false){
        ...
        this.game.physics.arcade.overlap(this.theHero, this.greenG, this.fallGreen, null, this);
        this.game.physics.arcade.overlap(this.theHero, this.blackG, this.fallBlack, null, this);
        this.game.physics.arcade.overlap(this.theHero, this.lightGreen, this.lightGreen, null, this);
       // this.game.physics.arcade.overlap(this.theHero, this.greenG, this.fallGreen, null, this);
